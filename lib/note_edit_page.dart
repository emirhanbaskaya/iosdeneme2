              ...
              children: [
                AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    color: _isTitleFocused ? Colors.blue[100] : Colors.white,
                ...
                AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    color: _isDescriptionFocused ? Colors.blue[100] : Colors.white,
                    borderRadius: BorderRadius.circular(12.0),
                  ...
                  child: TextFormField(
                    ...
                    style: TextStyle(color: Colors.blue[900], fontSize: 12), // Font boyutunu küçülttük
                    decoration: InputDecoration(
                      hintText: 'Açıklama',
                      border: InputBorder.none,
                    ),
                  ...
                  GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return GestureDetector(
                        onTap: () {
                          _showImageDialog(_imagePaths[index]);
                        },
                        child: Stack(
                          children: [
                            Container(
