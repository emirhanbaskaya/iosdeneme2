...
import 'dart:convert';
import 'dart:ui'; // Bu satırı ekleyin
...
class _NoteDetailPageState extends State<NoteDetailPage> {
  ...
  Future<String> askQuestion(String text) async {
    final response = await http.post(
      ...
      headers: {
        ...
        'Authorization': 'Bearer YOUR-API-KEY-HERE', // Geçerli API anahtarınızı burada kullanın
      },
      body: json.encode({
        'model': 'gpt-3.5-turbo',
        'messages': [
  ...
  Widget build(BuildContext context) {
    ...
    TextStyle defaultTextStyle = TextStyle(fontSize: 12, color: Colors.black); // Font boyutunu küçülttük
    TextStyle turkishFontStyle = TextStyle(fontSize: 12, color: Colors.black, fontFamily: 'NotoSerif'); // Font boyutunu küçülttük
